...
namespace Digimon.Database.Migrations
{
    ...
    [Migration("20220813001222_AddCardType")]
            ...
            modelBuilder.Entity("Digimon.Database.Models.Card", b =>
                {
                    ...
                    b.HasIndex("TypeId")
                        .HasDatabaseName("ix_cards_type_id");

                    b.ToTable("cards", (string)null);
                });

            modelBuilder.Entity("Digimon.Database.Models.CardType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Digimon.Database.Models.Card", b =>
                {
                    ...
                    b.HasOne("Digimon.Database.Models.CardType", "Type")
                        .WithMany()
                        .HasForeignKey("TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_cards_card_types_type_id");
